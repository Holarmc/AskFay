...
const Header = () => {
  return (
    <header className="p-2 sticky top-0 left-0 right-0">
      <NavBar />
      <Search />
    </header>
  );
...
const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-light p-2">
      ...
      <div>
        <ul className="flex justify-between p-4 text-black60">
          <li>English</li>
          <li>Hausa</li>
          <li>Yoruba</li>
          <li>Igbo</li>
...
export default function App() {
  return (
    <html lang="en">
      ...
      <body className="container bg-gray font-inter">
        <div className="max-w-screen-lg mx-auto relative px-2">
          {/* max-w-screen-xlg */}
          <Header />
          <Outlet />
          <Footer />
